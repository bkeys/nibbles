...
PACKAGE_NAME = snake
PACKAGE_STRING = snake 1
PACKAGE_TARNAME = snake
...
STRIP = 
VERSION = 1
abs_builddir = /home/bkeys/Devel/snake
abs_srcdir = /home/bkeys/Devel/snake
abs_top_builddir = /home/bkeys/Devel/snake
abs_top_srcdir = /home/bkeys/Devel/snake
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
snake$(EXEEXT): $(snake_OBJECTS) $(snake_DEPENDENCIES) $(EXTRA_snake_DEPENDENCIES) 
	@rm -f snake$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(snake_OBJECTS) $(snake_LDADD) $(LIBS)
